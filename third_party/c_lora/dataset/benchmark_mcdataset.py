...
class BenchmarkMCDataset(DatasetBase):
    ...
    def _loader(self, ds: Dataset, batch_size: int) -> DataLoader:
        return DataLoader(
            ds,
    ...
    def get_loaders(self):
        ...
        if eval_task == self.source_task:
            ...
            test_split_name = source_eval_name
        else:
        ...
        self.train_dataloader = self._loader(train_proc, self.args.batch_size)
        self.val_dataloader = self._loader(train_eval_proc, self.args.batch_size)
        self.valid_dataloader = self.val_dataloader
        self.test_dataloader = self._loader(test_proc, self.args.batch_size)
